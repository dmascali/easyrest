function RPmetrics = RP_metrics(rp,type,ReferenceImage)
%compute various RP based metrics
% rp can be the path to rp file or the loaded rp matrix
% type can be {'FSL','SPM','AFNI','HCP'}
