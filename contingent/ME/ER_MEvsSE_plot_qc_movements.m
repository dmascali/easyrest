function ER_MEvsSE_plot_qc_movements(data,sample_names,paired,sample)
...
isto_plot(data.fd,sample,[sp_r sp_c 1],'FD',sample_names,'mm',paired,fntsz,fntw);
isto_plot(data.fd_rms,sample,[sp_r sp_c 2],'rms FD',sample_names,'mm',paired,fntsz,fntw);
isto_plot(data.fd_TRnorm_rms,sample,[sp_r sp_c 4],'rms FD/tr',sample_names,'mm',paired,fntsz,fntw);
isto_plot(data.fd_TRnorm,sample,[sp_r sp_c 3],'FD/tr',sample_names,'mm',paired,fntsz,fntw);
isto_plot(data.rms,sample,[sp_r sp_c 5],'rms RP',sample_names,'mm',paired,fntsz,fntw);
isto_plot(data.rms_dvars,sample,[sp_r sp_c 6],'rms DVARS',sample_names,'|\Delta%BOLDx10|',paired,fntsz,fntw);
isto_plot(data.rms_sd,sample,[sp_r sp_c 7],'rms SD',sample_names,'%BOLDx10',paired,fntsz,fntw);
