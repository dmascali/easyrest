function ER_MEvsSE_plot_tsnr(data,sample_names,paired,sample)
...
sp_c = 4;
% for r = 1:5
%     isto_plot(data.tSNR_mean{r},sample,[sp_r sp_c (sp_c*(r-1)+1)],'t-SNR',sample_names,'',paired,fntsz,fntw);
% end
% show only raw data
 isto_plot(data.tSNR_mean{1},sample,[sp_r sp_c 1],'t-SNR',sample_names,'',paired,fntsz,fntw);
isto_plot(data.mean_dvars,sample,[sp_r sp_c 2],'mean DVARS',sample_names,'|\Delta%BOLDx10|',paired,fntsz,fntw);
isto_plot(data.rms_dvars,sample,[sp_r sp_c 3],'rms DVARS',sample_names,'|\Delta%BOLDx10|',paired,fntsz,fntw);
isto_plot(data.rms_sd,sample,[sp_r sp_c 4],'rms SD',sample_names,'%BOLDx10',paired,fntsz,fntw);
